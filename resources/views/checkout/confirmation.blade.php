...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white shadow-2xl rounded-xl overflow-hidden">
            <!-- Success header with professional gradient -->
            <div class="bg-gradient-to-r from-green-600 to-green-700 p-8 sm:p-10 text-white">
                <div class="flex flex-col sm:flex-row items-center">
                    ...
                    <div class="text-center sm:text-left">
                        <h1 class="text-3xl sm:text-4xl font-bold tracking-tight">Order Successfully Confirmed</h1>
                        <div class="mt-4 space-y-2">
                            <p class="text-lg font-medium opacity-90 flex items-center justify-center sm:justify-start">
                                ...
                                Reference: <span class="font-semibold ml-1">#{{ $order->order_number }}</span>
                            </p>
                            <p class="text-base opacity-80 flex items-center justify-center sm:justify-start">
                                ...
                                Confirmation sent to: <span class="font-medium ml-1">{{ $order->customer_email }}</span>
                            </p>
            ...
            <div class="p-8 sm:p-10 lg:p-12">
                    ...
                    <div class="bg-gray-50 p-7 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium text-gray-900">{{ $order->created_at->format('F d, Y \a\t H:i') }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 flex items-center">
                                    <svg class="w-5 h-5 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="text-2xl font-bold text-green-600">{{ number_format($order->total, 2) }} TND</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 flex items-center">
                                    <svg class="w-5 h-5 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium text-gray-900 capitalize">
                                    {{ $order->delivery_method === 'express' ? 'Express (24h)' : 'Standard (3-5 business days)' }}
                                </span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex flex-wrap gap-x-4 gap-y-2 mt-3">
                                    ...
                                    <p class="text-sm text-gray-600 flex items-center">
                                        ...
                                        Unit price: {{ number_format($item->price, 2) }} TND
                                    </p>
                                </div>
                            </div>
                            <div class="ml-6 text-right">
                                <p class="text-lg font-bold text-gray-900">{{ number_format($item->price * $item->quantity, 2) }} TND</p>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="flex flex-col lg:flex-row justify-between items-center border-t border-gray-200 pt-10">
                    <div class="mb-6 lg:mb-0">
                        <p class="text-xl text-gray-600 mb-2">Order Total Amount</p>
                        <p class="text-3xl font-bold text-green-600">{{ number_format($order->total, 2) }} TND</p>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                        <a href="{{ url('/') }}" class="px-8 py-3.5 bg-black hover:bg-gray-800 text-white rounded-lg transition duration-150 flex items-center justify-center text-lg font-medium shadow-md hover:shadow-lg">
                ...
                <div class="text-center px-4">
                    <div class="max-w-md mx-auto">
                        <p class="text-gray-600 mb-4">
                            For any questions regarding your order, our team is available:
                        </p>
