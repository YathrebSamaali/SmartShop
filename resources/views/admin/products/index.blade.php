    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-gray-600 mb-0">Complete list of products</p>
            </div>
            ...
            <div class="d-flex align-items-center">
                <div>
                    ...
                    <ul class="mb-1 ps-3" style="list-style-type: circle;">
                        <li><strong>Export:</strong> Download product reports in three formats: PDF, Excel, or CSV</li>
                        <li><strong>Search:</strong> Find products by name, category or description</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-solid from-blue-50 to-indigo-50">
                            <tr>
                                ...
                                <th scope="col" style="width: 22%" class="px-4 py-3 text-left text-xs font-semibold text-indigo-800 uppercase tracking-wider">Description</th>
                                <th scope="col" style="width: 10%" class="px-4 py-3 text-left text-xs font-semibold text-indigo-800 uppercase tracking-wider">Price</th>
                                <th scope="col" style="width: 10%" class="px-4 py-3 text-left text-xs font-semibold text-indigo-800 uppercase tracking-wider">Stock</th>
                                <th scope="col" style="width: 15%" class="px-4 py-3 text-left text-xs font-semibold text-indigo-800 uppercase tracking-wider">Category</th>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 avatar-cell">
                                            @if($product->image)
                                                <img class="avatar-img rounded" src="{{ asset('storage/'.$product->image) }}" alt="{{ $product->name }}">
                                            @else
                                                <img class="avatar-img rounded" src="https://via.placeholder.com/50" alt="No image">
                                            @endif
                                        </div>
                                        <div class="ml-3">
            ...
            @else
                <div class="no-results-overlay d-flex align-items-center justify-content-center">
                    <div class="text-center p-5">
                        ...
                        <h3 class="text-gray-700 mb-2">No products found</h3>
                        <p class="text-gray-500 mb-4">Your search "{{ request('search') }}" returned no matching products.</p>
                        @if(request('search'))
