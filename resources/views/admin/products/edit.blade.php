...
<div class="content" style="margin-left: 230px; background-color: #f8f9fa; ">
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- Prix -->
            <div class="mb-4">
                <label for="price" class="block text-gray-700 mb-2">Prix (DT)</label>
...
<div class="mb-4">
            ...
            <!-- Image -->
            <div class="mb-6">
                <label for="image" class="block text-gray-700 mb-2">Image du produit</label>
                <input type="file" name="image" id="image"
                       class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                @if($product->image)
                    <div class="mt-2">
                        <img src="{{ Storage::url($product->image) }}" alt="Image actuelle" class="h-20 w-20 object-cover rounded-md">
