    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-start mb-5">
            <div>
                ...
                <p class="text-gray-600 mb-0">Liste complète des utilisateurs enregistrés</p>
            </div>
            <div class="text-right">
                ...
                <p class="text-muted small mt-2">Cliquez pour créer un nouvel utilisateur</p>
            </div>
        </div>
...
<td class="px-6 py-4 whitespace-nowrap">
    <div class="flex items-center">
        <div class="flex-shrink-0 h-12 w-12">  <!-- Augmenté de h-10 w-10 à h-12 w-12 -->
            <img class="h-12 w-12 rounded-full" src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=random&size=128" alt="Avatar de {{ $user->name }}">
        </div>
        <div class="ml-4">
            <div class="text-sm font-medium text-gray-900">{{ $user->name }}</div>
            <div class="text-sm text-gray-500">{{ $user->email }}</div>  <!-- Ajout de l'email sous le nom -->
        </div>
    </div>
</td>
                            <!-- Email -->
